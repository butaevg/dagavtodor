...
class Article(models.Model):
    name = models.CharField(max_length=512, verbose_name='Заголовок')
    body = models.TextField(verbose_name='Текст')
    pic = models.ImageField(max_length=250, blank=True, upload_to='upload/smi', verbose_name='Фото')
    putdate = models.DateField(verbose_name='Дата')
...
class Photo(models.Model):
    url = models.ImageField(max_length=250, upload_to='upload/photo', verbose_name='Фото')
...
class Post(models.Model):
    ...
    body = models.TextField(verbose_name='Текст')
    mainpic = models.ImageField(max_length=250, upload_to='upload/news', verbose_name='Картинка на главной')
    putdate = models.DateField(verbose_name='Дата')
...
class PostImg(models.Model):
    pic = models.ImageField(max_length=250, upload_to='upload/news', verbose_name='Фотографии к новости')
...
class Question(models.Model):
    ...
    img = models.ImageField(blank=True, upload_to='upload/faq', verbose_name='Прилагаемoе фото')
